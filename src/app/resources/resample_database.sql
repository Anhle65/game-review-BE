...
INSERT INTO `game` (`id`, `title`, `description`, `creation_date`, `image_filename`, `creator_id`, `genre_id`, `price`) VALUES
  (1, 'Battle Quest', 'A high-stakes action game set in a mythical world.', '2024-10-15 14:30:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676322/battle_quest_lqtav8.jpg', 1, 1, 0),
  (2, 'Mystic Realms', 'Explore ancient ruins and uncover hidden secrets in this adventure game.', '2024-10-16 09:15:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676331/mystic_realms_ei2qbd.jpg', 2, 2, 3999),
  (3, 'Dragon Slayer', 'An epic RPG journey filled with dragons, magic, and choices that matter.', '2024-11-01 16:45:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676322/dragon_slayer_ammji7.jpg', 3, 3, 5999),
  (4, 'Mind Bender', 'Challenge yourself with puzzles that get increasingly difficult.', '2024-09-05 11:20:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676331/mind_bender_zsffvx.jpg', 4, 4, 999),
  (5, 'Farm Life', 'A relaxing simulation game where you build your own farm.', '2024-08-22 10:00:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676322/farm_life_baz1d6.jpg', 5, 5, 1999),
  (6, 'Empire Conquest', 'Lead your armies to victory in this strategy game.', '2024-07-10 13:00:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676322/empire_conquest_fowjp7.jpg', 6, 6, 2999),
  (7, 'Goal Masters', 'A sports game focused on realistic soccer gameplay.', '2024-06-15 15:30:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676323/goal_masters_yel1r3.jpg', 7, 7, 0),
  (8, 'Nightmare Escape', 'Survive the horrors of an abandoned asylum.', '2024-05-20 20:00:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676331/nightmare_escape_wqn8pf.jpg', 8, 8, 3999),
  (9, 'Speed Racer', 'An intense racing game on challenging tracks.', '2024-04-12 17:45:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676337/speed_racer_hvddxx.jpg', 9, 9, 2999),
  (10, 'Martial Fury', 'A fighting game with martial arts and combos.', '2024-03-29 18:30:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676331/martial_fury_bnj7pu.jpg', 10, 10, 4499),
  (11, 'Warrior Legends', 'Step into the shoes of a hero in an action-filled world.', '2024-01-20 15:00:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676321/warrior_legends_djje4e.jpg', 11, 1, 0),
  (12, 'Cave Explorer', 'Adventure deep into a mysterious cave system.', '2024-02-02 09:30:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676321/cave_explorer_onlt3p.jpg', 12, 2, 3499),
  (13, 'Fantasy Quest', 'A classic RPG with magic, quests, and exploration.', '2024-07-25 13:45:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676322/fantasy_quest_unza3h.jpg', 13, 3, 5999),
  (14, 'Puzzle Escape', 'A unique puzzle game that challenges your mind.', '2024-03-17 14:00:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676331/puzzle_escape_dnscwp.jpg', 14, 4, 1499),
  (15, 'City Builder', 'Build and manage your own city.', '2024-06-10 11:15:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676322/city_builder_ucdzi2.jpg', 15, 5, 2499),
  (16, 'Galactic War', 'Strategize and conquer the galaxy.', '2024-04-22 12:45:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676322/galactic_war_ruj5nz.jpg', 16, 6, 5499),
  (17, 'Street Soccer', 'Experience the thrill of street soccer.', '2024-07-10 10:30:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676337/street_soccer_i21ipc.jpg', 17, 7, 2999),
  (18, 'Haunted Manor', 'A horror game set in a haunted mansion.', '2024-05-28 19:45:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676323/haunted_manor_lqt03b.jpg', 18, 8, 0),
  (19, 'Turbo Drift', 'Race through various environments in fast cars.', '2024-04-10 17:15:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676319/turbo_drift_ldqlfj.jpg', 19, 9, 3799),
  (20, 'Samurai Duel', 'Fight against enemies in samurai battles.', '2024-02-12 16:00:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676337/samurai_duel_qirczp.jpg', 20, 10, 4499),
  (21, 'Alien Invasion', 'Protect Earth from alien threats in this action game.', '2024-01-14 10:20:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676321/alien_invasion_y5ynnc.jpg', 1, 1, 5299),
  (22, 'Mystery Island', 'Adventure across a deserted island with hidden secrets.', '2024-09-15 14:50:00', 'https://res.cloudinary.com/dravrz1ty/image/upload/v1751676331/mystery_island_qvq44p.jpg', 2, 2, 4399);
